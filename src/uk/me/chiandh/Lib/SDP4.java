...
subroutine, which is used by both SDP4 and SDP8.</p>
...
<ol>
  ...
  That port is the code used in Sputnik up to version 1.9 (June 2002).</li>
  ...
  This never went beyond the testing stage.</li>
  ...
  This also never went beyond the testing stage.</li>
  ...
  <ol>
    ...
    enough.  This later turned out to be a Y2K bug in THETAG.</li>
    ...
    to be simplified by duplicating some code and in general despagging
    it.</li>
  ...
  used in Sputnik 1.9.x from 1.9.3 onwards.</li>
</ol>
...
is by standard exactly 22 characters long.</p>
...
of the orbital elements).  It is unlikely to be for J2000 or B1950.</p>

<p>To use this class:</p>

<ol>
  <li>Create an instance of the class.</li>
  <li>Invoke its Init() method.</li>
  <li>Invoke its NoradByName() method to read the TLE for one satellite
  from a file with one or more TLEs for different satellites.</li>
  <li>Invoke its GetPosVel() method with the Julian Date of interest.</li>
  <li>Retrieve some of the public state variables itsR[], itsV[],
  itsEpochJD, itsDesignator, itsName, itsNumber.</li>
  <li>Repeat GetPosVel() for different times.</li>
</ol>
...
<dl>
<dt><strong>2003-03-06:</strong> hme</dt>
<dd>Translated from despagged Fortran code.</dd>
<dt><strong>2003-03-08:</strong> hme</dt>
<dd>All code ported.  SGP4 seem accurate, SDP4 is not accurate.  Likely flow
  control problem with the endless loops.</dd>
<dt><strong>2003-03-09:</strong> hme</dt>
<dd>After taking care of Fortran's by-reference calls and the
  ...
  wrong (though consistent with the SDP8 Java port).</dd>
<dt><strong>2003-03-09:</strong> hme</dt>
<dd>In fact the bug was in identifying satellites by name.  The two problem
  ...
  with Kelso's Pascal port.</dd>
<dt><strong>2003-03-09:</strong> hme</dt>
<dd>Changed from a sub-class of NamedObject (and hence Catalog) to a
  base class.</dd>
<dt><strong>2003-03-09:</strong> hme</dt>
<dd>Removed dependency on other classes.  Output from driver2 is now badly
  ...
  there any more, so the dependency on SputnikException is also gone.</dd>
<dt><strong>2003-03-09:</strong> hme</dt>
<dd>Documentation.</dd>
<dt><strong>2003-04-05:</strong> hme</dt>
<dd>Added NoradNext method.</dd>
...
<dd>Package review.
  ...
  the satellite is not in the file or the TLEs are not in order.</dd>
</dl>
