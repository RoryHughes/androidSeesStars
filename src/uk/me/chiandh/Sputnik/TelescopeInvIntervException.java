...
/**
 * <p>The <code>TelescopeInvIntervException</code> is thrown when a given
 * interval ends before it starts.</p>
 *
...
public final class TelescopeInvIntervException extends TelescopeException {
  public TelescopeInvIntervException()         {super();}
  public TelescopeInvIntervException(String s) {super(s);}
}
