...
/**
 * <p>The <code>CometInvLineException</code> is thrown when an object's line
 * in the file of orbit data fails to parse.</p>
 *
...
public final class CometInvLineException extends CometException {
  public CometInvLineException()         {super();}
  public CometInvLineException(String s) {super(s);}
}
