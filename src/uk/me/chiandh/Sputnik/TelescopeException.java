...
/**
 * <p>The <code>TelescopeException</code> is superclass for any exceptions that
 * may be thrown by the {@link Telescope Telescope} class.</p>
 *
...
public class TelescopeException extends Exception {
  public TelescopeException()         {super();}
  public TelescopeException(String s) {super(s);}
}
