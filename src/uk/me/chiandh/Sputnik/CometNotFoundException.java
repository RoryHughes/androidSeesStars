...
/**
 * <p>The <code>CometNotFoundException</code> is thrown when a named object
 * is not found in the file given.</p>
 *
...
public final class CometNotFoundException extends CometException {
  public CometNotFoundException()         {super();}
  public CometNotFoundException(String s) {super(s);}
}
