...
/**
 * <p>The <code>StationException</code> is superclass for any exceptions that
 * may be thrown by the {@link Station Station} class.</p>
 *
...
public class StationException extends Exception {
  public StationException()         {super();}
  public StationException(String s) {super(s);}
}
