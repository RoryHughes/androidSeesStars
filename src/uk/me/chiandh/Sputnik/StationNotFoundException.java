...
/**
 * <p>The <code>StationNotFoundException</code> is thrown when a requested
 * station cannot be found in the file given.</p>
 *
...
public final class StationNotFoundException extends StationException {
  ...
  public StationNotFoundException(String s) {super(s);}
}
