...
/**
 * <p>The <code>SputnikException</code> is superclass for any exceptions that
 * may be thrown by the {@link SputnikUI SputnikUI} class.
 *
...
public class SputnikException extends Exception {
  public SputnikException()         {super();}
  public SputnikException(String s) {super(s);}
}
